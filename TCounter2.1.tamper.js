...
if (0 === window.location.href.indexOf('http://www.myfreecams.com/mfc2/static/player.html')) {
    ...
    var MAssist = (function () {
        ...
        function setupHTML() {
            ...
            var txtMenuText = document.createTextNode('TCounter 2.1');
        ...
        //Topic Special 1
        TpcSpec1 = 0
        TpcSpecTxt1 = " set option 1 text";
		AllowSpecial1 = true;
        //Topic Special 2
        TpcSpec2 = 0;
        TpcSpecTxt2 = " set option 2 text ";
		AllowSpecial2 = true;
        //Topic Special 3
        TpcSpec3 = 0;
        TpcSpecTxt3 = " set option 3 text ";
		AllowSpecial3 = true;
        //Topic Special 4
        TpcSpec4 = 0;
        TpcSpecTxt4 = " set option 4 text ";
		AllowSpecial4 = true;
        //Topic Special 5
        TpcSpec5 = 0;
        TpcSpecTxt5 = " set option 5 text ";
		AllowSpecial5 = true;
        //Topic Special 6
        TpcSpec6 = 0;
        TpcSpecTxt6 = " set option 6 text ";
		AllowSpecial6 = true;
        ...
        function postCurrentCount() {
            ...
            TopicText1 = ("$$value$$ insert topic 1 text").replace("$$value$$", CDAmt1);
            TopicText2 = ("$$value$$ insert topic 2 text").replace("$$value$$", CDAmt2);
            TopicText3 = ("$$value$$ insert topic 3 (normally a show) text").replace("$$value$$", CDAmt3);
            TopicText4 = ("$$value$$ insert topic 2 (normally a show) text").replace("$$value$$", CDAmt4);
            TopicText5 = ("insert final topic text, has no countdown");
            InterimTopic = ("insert interim topic text normally used between topic 3 & 4 for 10min cooldown");
            ...
            VidMsg = "edit to change what it posts about video information";
            if (countDown >= T1) {
        ...
        function handleStart(msgSpan) {
            ...
            var nameSpan = msgSpan.parentNode.querySelector('a span.name_model');
            if (nameSpan) {
                postie = nameSpan.innerHTML.replace(/:/, '');
                if (currentModelName === postie) {
                    isCountDownActive = true;
                    countDown = T1;
                    autoPostActive = true;
                    postCurrentCount();
        ...
        function handlePlus(plusMsg, msgSpan) {
            ...
            if (nameSpan) {
                ...
                if (currentModelName === postr || 'Parkesy86' === postre) {
                    //parse the value
        ...
        function updateCountDown3(amount) {
            ...
            if ((countDown - T4) <= 0){
                ...
                countDown = T4;
                isCountDownActive = true;
                if (autoPostActive = true){
                postChatMessage(TwitMsg);
                postChatMessage("/topic " + InterimTopic);
                postChatMessage(PMValue + " topic complete, interim topic posted for 10 mins");
        ...
        function modelChanged(modelId) {
            ...
            postRegex = "^$$model$$ (post count|Post Cout|Post count|post Count)$".replace("$$model$$", currentModelName);
